...
const EMAIL = "contact@tonydecay.com";
    ...
    >
        ...
        <div ref={contentRef} className="opacity-0">
          ...
          <div className="flex flex-wrap gap-3 mt-10">
            <a
              ...
              className="group inline-flex items-center gap-3 font-sans text-sm text-ink bg-ink/5
                         hover:bg-ink hover:text-paper transition-all duration-300 px-6 py-3 rounded-full"
            >
            ...
            <button
              ...
              className="group inline-flex items-center gap-3 font-sans text-sm text-ink bg-ink/5
                         hover:bg-ink hover:text-paper transition-all duration-300 px-6 py-3 rounded-full cursor-pointer"
              title={EMAIL}
            >
      ...
      {copied && (
        <div
          ...
          style={{ left: toastPos.x + 16, top: toastPos.y - 30 }}
        >
          <div className="px-3 py-1.5 bg-ink text-paper font-mono text-xs tracking-wider shadow-lg rounded-full">
            Copied!
          </div>
        </div>
      )}
