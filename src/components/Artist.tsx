...
export function Artist() {
  ...
  return (
    <section
      ref={sectionRef}
      id="artist"
      className="bg-bg relative overflow-hidden py-28 sm:py-36"
    >
      <div className="max-w-5xl mx-auto px-6 sm:px-10">
        {/* Full-width heading */}
        <h2
          ref={headingRef}
          className="font-tattoo text-[5rem] sm:text-[8rem] md:text-[12rem] text-paper uppercase tracking-tighter leading-[0.78] px-0 opacity-0"
        >
          THE ARTIST
        </h2>
        ...
        <div
          ref={bioRef}
          className="grid grid-cols-1 md:grid-cols-2 gap-16 mt-14 opacity-0"
        >
          {/* Left column — bio text */}
          <div className="space-y-6">
            <p className="font-sans text-base sm:text-lg text-paper/70 leading-relaxed">
              ...
              linework and vibrant color with characters that defined a
              generation.
            </p>
            <p className="font-sans text-base sm:text-lg text-paper/70 leading-relaxed">
              Based between Lima and the internet, Tony has built a following
              around his distinctive fusion of traditional tattooing and
              nostalgic illustration - creating work that lives at the
              intersection of heritage craft and contemporary culture.
            </p>
          </div>

          {/* Right column — disciplines + IG */}
          <div className="space-y-10">
            {/* Discipline chips */}
            <div>
              <p className="font-mono text-xs text-paper/40 uppercase tracking-[0.2em] mb-3">
                Disciplines
              </p>
              <div className="flex flex-wrap gap-2">
                {DISCIPLINES.map((d) => (
                  <span
                    key={d}
                    className="inline-flex items-center px-3 py-1 border border-paper/15 rounded-full font-mono text-xs text-paper/50"
                  >
                    {d}
                  </span>
                ))}
            ...
            <div>
              <a
                ...
                className="inline-flex items-center gap-3 font-sans text-base text-paper/80 hover:text-paper transition-colors"
              >
                <svg
                  width="20"
                  height="20"
              ...
              <p className="font-mono text-xs text-paper/30 mt-1.5 ml-[32px]">
